...
<center>
	<br><br>
		<font color="yellow" size=10px>View DeplomainActing Courses Table Record</font><br><br>
		 
		<br>
		<br>
		<h3>
				<form action="DeplomainActingsave" method="post">
...
<b><p>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p></b>
		...
		PreparedStatement ps = connection.prepareStatement("select * from deplomain_acting");
