...
<center>
	<br><br>
		<font color="yellow" size=10px>View Bachelor in Theatre Course</font><br><br>
		 
		<br>
		<br>
		<h3>
				<form action="saveViewBachelorinTheatre" method="post">
...
<b><p>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p></b>
		...
		PreparedStatement ps = connection.prepareStatement("select * from bachelorin_theatre");
