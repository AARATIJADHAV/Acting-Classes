...
<style>
/*  body{
     background-image:url('img/bgimg.jpg.jpg');
...
.team-carousel .owl-nav, .related-carousel .owl-nav {
    position: absolute;
    width: 100%;
    height: 60px;
    top: calc(50% - 30px);
...
<body>
   ...
   <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="section-title text-center position-relative mb-6">
              
                <h1 class="display-4"><font color="White">Meet Our Instructors Actoress</font> </h1>
            </div>
            <div class="owl-carousel team-carousel position-relative" style="padding: 10 10px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/shivani.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Ms.Shivani Rangole</h5>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/pooja.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3"> Ms.pooja Birari</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                            <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/ins3.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3"> Ms.Tejashree Paradhan</h5>
                        <p class="mb-2">Instructor</p>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/ins4.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Ms.Jui Gadkari</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                      <div class="d-flex justify-content-center">  <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
     ...
     <div class="container-fluid py-0">
        <div class="container py-0">
            <div class="section-title text-center position-relative mb-0">
               
                <h1 class="display-4"> <font color="White">Meet Our Instructors Actor</font></h1>
            </div>
            <div class="owl-carousel team-carousel position-relative" style="padding: 10 10px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/shashank.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr.Shashank Ketkar </h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                            <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/akshar.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3"> Mr.Akshar kothari</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                            <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/ins6.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr. Amit Bhanushali</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">  <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a class="mx-1 p-1" href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/ins5.jpg.jpg" alt=""= style="width:400px;height:400px">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr.Sddidarth Chadekar</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                      <div class="d-flex justify-content-center">  <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center text-md-right">
                    <p class="m-0">Designed by <a class="text-white" href="https://www.youtube.com/@JavaWithGG">Aarati Jadhav</a>
                    </p>
                </div>
            </div>
        </div>
