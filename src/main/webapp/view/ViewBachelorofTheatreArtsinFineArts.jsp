...
<center>
	<br><br>
		<font color="yellow" size=10px>View Bachelor of Theatre Arts in Fine Arts</font><br><br>
...
<b><p>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p></b>
		...
		PreparedStatement ps = connection.prepareStatement("select * from bachelorof_theatre_artsin_fine_arts");
