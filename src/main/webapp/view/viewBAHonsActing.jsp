...
<body>
	...
	<center>
	<br><br>
		<font color="yellow" size=10px>View BA(Hons)Acting Courses Table Record</font><br><br>
		 
		<br>
		<br>
		<h3>
				<form action="saveBaHonsActing" method="post">
...
<b><p>------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------</p></b>
		...
		PreparedStatement ps = connection.prepareStatement("select * from ba_hons_acting");
